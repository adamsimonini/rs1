...
export default {
  ...
  methods: {
    loaded(map){
            ...
            var rs1_centroids_url = 'https://radarsat-1-archive.space/assets/catalog_centroids.geojson';
            ...
            var rs1_extents_url = 'https://radarsat-1-archive.space/assets/catalog_extents.geojson';
